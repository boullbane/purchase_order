...
<body>
	<div class="container col">
		...
		<div class="right-side">
			...
			<form action="deleteDevis.php?page=<?php echo $searchQuery; ?>" method="POST">
				<div class="card-header">
					<h2 class="text-center">Supprimer le devis</h2>
				</div>
				<?php
				echo errorMessage();
				echo succesMessage();
				...
				<div class="card-body">
					<div class="form-group row">
	               	...
	               	<div class="form-group row">
						...
						<div class="col-lg-8 input-group">							
							<select  class="form-control" name="desgProd" id="desgProd">
               		...
               		<div class="form-group row">
						...
						<div class="col-lg-8 input-group">
							<select  class="form-control mr-3" name="qte" id="qte">
								<option value="0" disabled>...</option>
								<?php
								$stmtAffiche=$connectDB->prepare("SELECT * FROM ligneCommandetb");
								$stmtAffiche->execute();
					...
					<div class="form-group row">
							<div class="col-lg-8 ml-auto">
	                            <button type="submit" name="deleteDevis" class="btn btn-danger">Delete le devis</button>
	                        </div>
					</div>
				</div>
			</form>
