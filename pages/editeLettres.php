...
<?php
	...
	include 'traitment_lettre.php';
		...
		if (isset($_POST['updateLetter'])) {
			...
			$sql="UPDATE commandetb SET ID_f='$nomSoc', ID_marche='$objetM' WHERE ID_cmd='$searchQuery'";
			...
			if ($exec) {
				...
				redirect_to("editeLettres.php?page=$searchQuery");
			}
			else {
...
<body>
	<div class="container col">
		...
		<?php 
			...
			INNER JOIN datetb ON datetb.ID_date=marchetb.ID_date WHERE commandetb.ID_cmd='$searchQuery'";
		...
		<div class="right-side">
			...
			<form action="editeLettres.php?page=<?php echo $searchQuery; ?>" method="POST">
				<div class="card-header">
					<h2 class="text-center">Modifier la lettre</h2>
				</div>
				<?php
				echo errorMessage();
				echo succesMessage();
				...
				<div class="card-body">
					...
					<div class="form-group row">
							<div class="col-lg-8 ml-auto">
	                            <button type="submit" name="updateLetter" class="btn btn-warning">Modifier la lettre</button>
	                        </div>
					</div>
				</div>
			</form>
